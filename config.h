...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,				XK_e,		spawn,			SHCMD("~/Scripts/dmenu/shutdowndm")			},
	{ MODKEY,						XK_p,		spawn,			SHCMD("~/Scripts/dmenu/scrot_screenshot")	},
	{ MODKEY,						XK_s,		spawn,			SHCMD("~/Scripts/quicklaunch")	},
